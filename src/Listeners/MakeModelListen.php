...
class MakeModelListen extends ListenerControl
{
    ...
    protected function makeFile(LevyModel $model): array
    {
        ...
        } else if (!$model->created && $model->updated) {
        ...
        foreach ($model->relations as $relation) {
            ...
            $method = $class->method($relation->relation_name)->line();
            $method->line("\$this->{$relation->name}(" . implode(', ', $this->formatArray($relation->relation->relation_params)) . ");");
        }
