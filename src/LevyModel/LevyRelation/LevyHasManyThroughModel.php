...
/**
 * Class LevyHasManyThroughModel.
 * @package Bfg\Scaffold\LevyModel\LevyRelation
 */
class LevyHasManyThroughModel extends LevyRelationAbstract
{
    /**
     * @var LevyModel|null
     */
     ...
     * @var string
     */
    public string $relation_class = "Illuminate\Database\Eloquent\Relations\HasManyThrough";
}
